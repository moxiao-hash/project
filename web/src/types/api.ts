...
export type AgentScope =
  ...
  | 'LEARNING_MANAGEMENT' | 'SETTINGS_MANAGEMENT' | 'NOTIFICATION_MANAGEMENT'
  | 'WORKSPACE_MANAGEMENT' | 'ARTIFACT_MANAGEMENT' | 'ROADMAP_MANAGEMENT'
  | 'RUNNER_MANAGEMENT' | 'DEVELOPER_MANAGEMENT'
...
export type ExecutionType =
  ...
  | 'LEARNING_GOAL_CHANGE' | 'USER_SETTINGS_CHANGE' | 'NOTIFICATION_CHANGE'
  | 'WORKSPACE_REGISTRATION' | 'ARTIFACT_SUBMISSION' | 'ROADMAP_CHANGE'
  | 'RUNNER_EXECUTION' | 'CODE_PATCH_APPLICATION' | 'GIT_COMMIT' | 'GIT_PUSH'
